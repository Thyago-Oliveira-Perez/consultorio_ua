<template>
  <div id="container">
    <h1 class="title is-2" style="color: #ffff">Detalhes de Convênio</h1>
    <div id="cadastro">
      <div id="input-field">
      ...
      <div id="input-field">
        <label>Status</label>
        <p v-if="convenio.ativo">Habilitado</p>
        <p v-if="!convenio.ativo">Desabilitado</p>
      </div>
    </div>
  </div>
...
export default class DetalhesConvenio extends Vue {
